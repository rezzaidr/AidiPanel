  ...
  <div class="card p-5">
    <div class="flex items-center gap-2.5 mb-4">
      <div class="w-8 h-8 bg-speed-pale rounded-lg flex items-center justify-center">
        <i class="ti ti-bolt text-speed text-base"></i>
      </div>
    ...
    <form method="POST" action="/cache/purge">
      ...
      <button type="submit"
        ...
        <i class="ti ti-trash text-sm"></i> <?= e(t('cache.purge_all')) ?>
      </button>
    </form>
  </div>
  ...
  <div class="card p-5">
    <div class="flex items-center gap-2.5 mb-4">
      <div class="w-8 h-8 bg-ink-pale rounded-lg flex items-center justify-center">
        <i class="ti ti-brand-redis text-ink text-base"></i>
      </div>
  ...
  <div class="card p-5">
    ...
    <form method="POST" action="/cache/purge" class="space-y-3">
      ...
      <button type="submit" class="btn btn-secondary btn-sm w-full">
        <i class="ti ti-refresh text-sm"></i> Purge URL
      </button>
    </form>
  </div>
...
<div class="card overflow-hidden">
  <div class="card-head">
    <h2 class="card-title"><i class="ti ti-bolt text-speed"></i> <?= e(t('cache.per_site_title')) ?></h2>
  </div>
  <?php if (empty($sites)): ?>
      ...
      <div class="flex items-center gap-2 shrink-0">
        ...
        <form method="POST" action="/cache/toggle">
          ...
          <button type="submit"
            ...
            <i class="ti <?= $cacheOn ? 'ti-bolt' : 'ti-bolt-off' ?> text-xs"></i>
