...
class CacheController extends BaseController
{
    ...
    private function objectCacheError(string $output): string
    {
        ...
        return match ($code) {
            ...
            'acl_provision_failed'   => "Couldn't create or verify this site's isolated Redis identity. No unsafe fallback was used.",
            ...
            'dropin_disable_failed'  => "Couldn't remove the Redis object-cache drop-in, so its isolated credential was kept active.",
            'plugin_deactivate_failed' => "The object cache was disconnected, but the Redis plugin couldn't be deactivated.",
            'object_cache_not_connected' => "The site's Redis object cache isn't connected. Its files or isolated credential may need repair.",
